...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SkewSlider"] = factory();
	else
		root["SkewSlider"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SkewSlider = (function () {
	    ...
	    Object.defineProperty(SkewSlider.prototype, "_getNextVisibleIndex", {
	        /**
	         * 次に表示させる画像のインデックス
	         */
	        get: function () {
	     ...
	     * 画像の事前読み込み
	     */
	    SkewSlider.prototype._preload = function (sources) {
	        var _this = this;
	    ...
	    SkewSlider.prototype._animate = function () {
	        ...
	        this._tweener = utility_1.tween({
	            ...
	            onUpdate: function (value) {
	                ...
	                _this._createClipPath(value);
	                _this._drawImage(_this._visibleIndex);
	                _this._ctx.restore();
	            }
	        });
...
;
//# sourceMappingURL=skewslider.js.map